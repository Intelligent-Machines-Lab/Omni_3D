...
class GlobalScene:
    ...
    def add_pcd(self, pcd, commands_odom_linear, commands_odom_angular, duration, i):
        ...
        print(vel_angular_body, vel_linear_body)
        isgazebo = False
        if(isgazebo):
        ...
        self.coordenadasmesh.append(o3d.geometry.TriangleMesh.create_coordinate_frame(size=0.5, origin=[0, 0, 0]).rotate(get_rotation_matrix_bti(atual_angulo), center=(0,0,0)).translate(atual_loc))
        self.fet_geo.extend(self.coordenadasmesh)
