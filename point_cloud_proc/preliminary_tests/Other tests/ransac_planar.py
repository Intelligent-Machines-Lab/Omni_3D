...
while(n < nImages):
		...
		if useGazebo:
			color_raw = o3d.io.read_image("images_a_gazebo/"+str(n)+"_rgb.png")
			depth_raw = o3d.io.read_image("images_a_gazebo/"+str(n)+"_depth.png")
			pcd = open_pointCloud_from_rgb_and_depth(color_raw, depth_raw, meters_trunc=10, showImages=False)
		else:
		#pcd = open_pointCloud(1)
			pcd = open_pointCloud_from_files(n = n, folder="images_alinhadas", end_color = "_rgb.jpg", end_depth="_depth.png", meters_trunc = 6, showImages = True)
